...
def DB_QSP(qarg, U_0, exp_H, s, k, method="GC"):
    r"""
    Performs `Double-Braket Quantum Signal Processing (DB-QITE) <https://arxiv.org/pdf/2504.01077>`_.
    ...
    * Higher-order product formula (HOPF) approximation:
    ...
    if not check_for_tracing_mode():
        ...
        if k == 0:
            ...
            def conjugator(qarg):
                with invert():
                    DB_QSP(qarg, U_0, exp_H, s, k - 1, method=method)
